...
program
	.version('1.0.0')
	.description(
		'Programa para levantar nuestro servidor con un ambiente especifico'
	)
	.option('-m, --mode <mode>', 'Ambiente de ejecución', 'development')
	.option('-p, --persistence <persistence>', 'Tipo de persistencia', 'MONGO')
	.parse();
